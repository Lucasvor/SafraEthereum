...
using SafraBC.Math.Raw;
using SafraBC.Security;
using SafraBC.Util;
using SafraBC.Util.Encoders;


namespace SafraBC.Math.EC.Custom.Sec;
    ...
    internal static class SecT163Field
    {
        ...
        {
#if NETCOREAPP3_0_OR_GREATER
            if (SafraBC.runtime.intrinsics.x86.Pclmulqdq.IsEnabled &&
                SafraBC.runtime.intrinsics.Vector.IsPackedLittleEndian)
            {
        ...
        {
#if NETCOREAPP3_0_OR_GREATER
            if (SafraBC.runtime.intrinsics.x86.Bmi2.X64.IsEnabled)
            {
