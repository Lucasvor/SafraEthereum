...
internal static class Nat256
{
    ...
    {
#if NETCOREAPP3_0_OR_GREATER
        if (SafraBC.runtime.intrinsics.x86.Avx2.IsEnabled &&
            SafraBC.runtime.intrinsics.Vector.IsPacked)
        {
        ...
        if (SafraBC.runtime.intrinsics.x86.Sse2.IsEnabled &&
            SafraBC.runtime.intrinsics.Vector.IsPacked)
        {
            var X = MemoryMarshal.AsBytes(x[..8]);
            var Y = MemoryMarshal.AsBytes(y[..8]);
